...
// return NOMORERECS when done iterating
...
// previous page pointer is used to implement the left link.
   ...
   Status adjust_key(const void *newKey, const  void* oldKey, AttrType key_type);

   bool redistribute(BTIndexPage *pptr, BTIndexPage *parentPtr, AttrType key_type,
