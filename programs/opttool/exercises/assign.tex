...
\centerline{Assignment 7:  Relational Query Optimization}
\centerline{Due: Friday, May 10, 1996, 5 p.m.}
...
The chapters on relational operator implementation and
query optimization and the lecture transparencies
...
%RR Chee-yong, Xumei, please add this to the 564 page ...
...
visualization tool.
%RR there is no such button!  (called catalogs now).  please check for
%consistency with current catalogs, optimizer version!
%KK changed "Optimizer Catalogs" to "Catalogs"
...
%<< answer: the range and number of jobs is different in this catalog >>
\end{enumerate}
