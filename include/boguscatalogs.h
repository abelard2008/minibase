...
private:
  Plan_Relation *ReadPlan_Relation(std::ifstream &infile);
  Attribute *ReadAttribute(std::ifstream &infile, Plan_Relation *relation);
  Plan_AccessMethod *ReadPlan_AccessMethod(std::ifstream &infile, Attribute *attribute);
}; 
